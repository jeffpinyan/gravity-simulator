  ...
  sol: {
    ...
    bodies: [
      ...
      },
      {
        ...
        m: 95.15,
        s: 9.44,
        p: new Vector2(9540, 0),
        v: new Vector2(0, 5.95),
        fill: "purple",
      },
    ],
  },
  ...
  earthMoon: {
    ...
    bodies: [
      ...
      },
      {
        ...
        m: MOON.Mass,
        s: MOON.Radius,
        p: new Vector2(EARTH.Distance.MOON.Perigee, 0),
        v: new Vector2(0, 1.0839e3),
        fill: "silver",
      },
    ],
  },
  ...
  earthISS: {
    ...
    bodies: [
      ...
      },
      {
        ...
        m: 400000,
        s: 1000,
        p: new Vector2(EARTH.Radius + 4.18e3, 0),
        v: new Vector2(0, 7.66e3),
        fill: "silver",
      },
    ],
  },
  ...
  try2: {
    ...
    bodies: [
      ...
      },
      {
        ...
        m: 50000,
        s: 25,
        p: new Vector2(6000, 0),
        v: new Vector2(0, -11.9),
        fill: "orange",
      },
    ],
  },
  ...
  magic1: {
    ...
    bodies: [
      ...
      },
      {
        ...
        m: EARTH.Mass * 0.6,
        s: SUN.Radius * 0.8,
        p: new Vector2(EARTH.Distance.SUN.Mean * 1.5, 0),
        v: new Vector2(0, 9.98e4),
        fill: "green",
      },
    ],
  },
  ...
  magic3: {
    ...
    bodies: [
      ...
      },
      {
        ...
        m: EARTH.Mass * 0.6,
        s: SUN.Radius * 0.8,
        p: new Vector2(EARTH.Distance.SUN.Mean, 0),
        v: new Vector2(0, 1.08e5),
        fill: "green",
      },
    ],
  },
    ...
    bodies: [
      {
        ...
        m: SUN.Mass * 1.8,
        s: SUN.Radius * 1.9,
        p: new Vector2(-SUN.Radius * 9.98585, 0),
        v: new Vector2(0, 0),
        fill: "cyan",
      },
      {
      ...
      },
      {
        ...
        m: EARTH.Mass * 0.6,
        s: EARTH.Radius * 0.8,
        p: new Vector2(EARTH.Distance.SUN.Mean * 1.50841, 0),
        v: new Vector2(0, 7.78e4),
        fill: "green",
      },
      {
        ...
        s: MOON.Radius * 0.7,
        p: new Vector2(
          EARTH.Distance.SUN.Mean * 1.50841 + EARTH.Distance.MOON.Perigee / 2,
          0
        ),
        v: new Vector2(0, 7.9e4),
        fill: "silver",
      },
    ],
  },
    ...
    bodies: [
      {
        ...
        m: SUN.Mass * 1.8,
        s: SUN.Radius * 1.87,
        p: new Vector2(-SUN.Radius * 9.544, 0),
        v: new Vector2(0, 0),
        fill: "cyan",
      },
      {
        ...
        <SVG.G>
          ...
          {bodies.map(({ m, s, p, v, a, ra, ...props }, i) => (
            <Body
              ...
              {...props}
              onClick={() =>
                setConfig((config) => ({ ...config, focus: i + 1 }))
              }
            />
          ))}
        </SVG.G>
...
const mouseToSvg = (svg, event) => {
  ...
  const { x, y } = svg.current.__p.matrixTransform(
